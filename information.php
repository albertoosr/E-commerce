...
<?php } else if ($id == 0) {  ?>
    ...
    <div class="container pl-5 imges mx-auto">
        <div align="center"><img src="resources/img/mail.png" alt=""></div>
    </div>
...
<?php } else if ($_GET['id'] == 9) { ?>
    ...
    <div class="container pl-5 imges mx-auto img-error">
        <div align="center"><img src="resources/img/error.png" alt=""></div>
    </div>
<?php
} else {
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-6 mt-2 mb-2 info-inputs">
                                ...
                                Captcha * <br><img src="captcha.php">
